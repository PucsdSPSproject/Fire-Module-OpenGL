...
static float a0=0.0f,a1=2.0f,a2=4.0f,a3=5.0f,a4=5.0f,a5=4.0f,a6=3.0f,a8=-3.0f,a9=-4.0f,b0=40.0f;
...
void drawSpline(void)
{
  ...
  GLfloat ctrlpoints[1][15][3]={{{a0,b0,0.0},{a1,35.0,0.0},{a2,30.0,0.0},{a3,25.0,0.0},{a4,20.0,0.0},{a5,15.0,0.0},{a6,10.0,0.0},{0.0,0.0,0.0},{a8,10.0,0.0},{a9,15.0,0.0},{-5.0,20.0,0.0},{-5.0,25.0,0.0},{-4.0,30.0,0.0},{-2.0,35.0,0.0},{a0,b0,0}}};
